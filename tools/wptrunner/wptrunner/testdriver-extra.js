...
(function() {
    ...
    const super_set_context = window.test_driver.set_test_context;
    ...
    const get_context = function(element) {
        ...
        return get_window_id(elementWindow);
    };
    ...
    const create_action = function(name, props) {
        ...
        if (is_test_context) {
            ...
            if (testharness_context === null) {
                throw new Error("Tried to run in a non-testharness window without a call to set_testharness_context");
            }
            cmd_id = ctx_cmd_id++;
    ...
    window.test_driver.set_test_context = function(context) {
